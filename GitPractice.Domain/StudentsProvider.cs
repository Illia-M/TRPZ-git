...
namespace TRPZ_git
{
    public class StudentsProvider
    {
        ...
        public StudentsProvider()
        {
            ...
            {
                { new GroupNumber("IC-31"), new[]{new Student("Oleksandr", "Sychov"), new Student("Mikita", "Kalachuk"),new Student("Oleh", "Lobko") }.ToImmutableList(), new Student("Artem", "Rusachenko") }.ToImmutableList() },
