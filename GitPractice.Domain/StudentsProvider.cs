    ...
    public StudentsProvider()
    {
        _students = new Dictionary<GroupNumber, ImmutableList<Student>>()
		    ...
		    new Student("Demych", "Serhii"),
                    ...
                    new Student("Kut", "Pavlo"),
                    new Student("Zub", "Denys"),
                }.ToImmutableList() },
                { new GroupNumber("IC-22"), new[]{
                    ...
                    new Student("Kateryna", "Kolomoichenko"),
                    new Student("Mykyta", "Honcharov"),
                    new Student("Vitalik", "Dovganyuk"),
                    new Student("Yehor", "Danylenko"),
                }.ToImmutableList() },
